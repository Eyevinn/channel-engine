...
class Session {
  ...
  async incrementAsync(incOpts) {
    ...
    } else { // TODO ADD BETTER INCREMENT
      ...
      try {
        ...
        slateVod.load()
          .then(() => {
            ...
            if (afterVod) {
              return this.use_demuxed_audio ? hlsVod.loadAfter(afterVod, null, slateMediaManifestLoader, slateAudioManifestLoader) : hlsVod.loadAfter(afterVod, null, slateMediaManifestLoader);
            } else {
              return this.use_demuxed_audio ? hlsVod.loadAfter(null, slateMediaManifestLoader, slateAudioManifestLoader) : hlsVod.loadAfter(afterVod, null, slateMediaManifestLoader)
            }
          })
          .then(() => {
            resolve(hlsVod);
